...
export const A_propos = () => {
    return (
        <div className="min-h-screen ">
            ...
            <section className="flex xxs:flex-col xs:flex-col xs:items-center sm:items-center sm:justify-center sm:flex-col md:flex-row lg:flex-row justify-between mt-36 pt-6 px-8 xs:text-xs sm:text-sm md:text-base lg:text-xl">
            ...
            <section className="flex xxs:flex-col-reverse xs:flex-col xs:flex-col-reverse xs:items-center sm:flex-col-reverse sm:items-center sm:justify-center sm:flex-col md:flex-row lg:flex-row justify-between p-7 xs:text-xs sm:text-sm md:text-base lg:text-xl">
                <div>
